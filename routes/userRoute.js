...
router.route('/allocate').post(isLoggedIn, authorize('Admin'), allocateMultipleIncharge)
router.route('/deallocate').post(isLoggedIn, authorize('Admin'), deallocateIncharge);
